<template>
  <div
    :class="[
      'flex justify-around text-center p-3 rounded-2xl text-black items-center',
      {
        'bg-red-200': rowData.flag.delete,
        'bg-amber-100': !rowData.flag.found,
        'bg-emerald-100': rowData.flag.found,
      },
    ]"
  >
